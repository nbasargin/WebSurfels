...
import { DynamicLodController } from 'web-surfels/lib/src/controllers/dynamic-lod/dynamic-lod-controller';
import { XhrLodLoader } from 'web-surfels/lib/src/data/level-of-detail/xhr-lod-loader';
